              ...
              <el-tab-pane label="账号密码登录" name="first" stretch>
                ...
                >
                  ...
                  <el-form-item prop="password">
                    ...
                    >
                    <!-- @keyup.enter.native='submit' 的作用是在用户输入密码后，当用户按下回车键时触发一个事件。这个事件被绑定到 submit 方法上，意味着按下回车键将会执行 submit 方法的逻辑。 -->
                    </el-input>
                  </el-form-item>
                  <el-form-item
                    prop="captcha"
                ...
                <!-- 例如，如果 componentTag 的值为 "my-component"，那么 <component> 元素将渲染成 <my-component></my-component>。 -->
              </el-tab-pane>
            </el-tabs>
          </el-card>
          <el-button
...
export default {
  // 使用继承方式将 base.vue 组件整体注入到当前组件中，使其成为当前组件的一部分
  extends: base,
  name: 'page',
  data () {
    return {
