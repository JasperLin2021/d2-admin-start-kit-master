<template>
  <d2-container :class="{ 'page-compact': crud.pageOptions.compact }">
    ...
    >
    <!-- 新增 @resetPassword="resetPassword"-->
      <div slot="header">
        <crud-search
          ref="search"
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="resetPwdSubmit">重 置1</el-button>
      </div>
    </el-dialog>
  </d2-container>
</template>
...
import { crudOptions } from './crud'  //默认
import { d2CrudPlus } from 'd2-crud-plus'  //默认
export default {
  name: 'user',
  mixins: [d2CrudPlus.crud], //默认
  data () {
  ...
  methods: {
    getCrudOptions () {
      this.crud.searchOptions.form.user_type = 0  //新增
